...
var invisibleUndergroundShader = function invisibleUndergroundShader() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    _ref$vertexColors = _ref.vertexColors,
    vertexColors = _ref$vertexColors === void 0 ? false : _ref$vertexColors;
  return {
    uniforms: {
      color: {
        type: 'vec4'
...
var HexBinLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    var topHexMaterials = {}; // indexed by color
    var sideHexMaterials = {}; // indexed by color
    ...
    if (state.hexBinMerge) {
      ...
      var hexPointsGeometry = !hexBins.length ? new THREE$c.BufferGeometry() : (BufferGeometryUtils$1.mergeGeometries || BufferGeometryUtils$1.mergeBufferGeometries)(hexBins.map(function (d) {
        ...
        // color vertices
        var topColor = color2ShaderArr(topColorAccessor(d), true, true);
        var sideColor = color2ShaderArr(sideColorAccessor(d), true, true);
      ...
      var hexPoints = new THREE$c.Mesh(hexPointsGeometry, new THREE$c.ShaderMaterial(_objectSpread2(_objectSpread2({}, invisibleUndergroundShader({
        vertexColors: true
      })), {}, {
        transparent: true,
    ...
    function updateObj(obj, d) {
      ...
      if (!state.hexBinMerge) {
        ...
        if (!sideHexMaterials.hasOwnProperty(sideColor)) {
          var opacity = colorAlpha(sideColor);
          sideHexMaterials[sideColor] = new THREE$c.ShaderMaterial(_objectSpread2(_objectSpread2({}, invisibleUndergroundShader()), {}, {
            transparent: opacity < 1,
            side: THREE$c.DoubleSide
          }));
        ...
        if (!topHexMaterials.hasOwnProperty(topColor)) {
          var _opacity = colorAlpha(topColor);
          topHexMaterials[topColor] = new THREE$c.MeshLambertMaterial({
  ...
  update: function update(state) {
    ...
    threeDigest(singlePolygons, state.scene, {
      ...
      createObj: function createObj() {
        ...
        obj.__defaultSideMaterial = new THREE$a.ShaderMaterial(_objectSpread2(_objectSpread2({}, invisibleUndergroundShader()), {}, {
